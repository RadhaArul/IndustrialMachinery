...
using IndustrialMachinery.Api.Data;
using IndustrialMachinery.Core;

namespace IndustrialMachinery.Api.Controllers
{
    [Route("api/[controller]")]
    [ApiController]
    public class MachinesController : ControllerBase
    {
        private readonly IndustrialMachineryApiContext _context;

        public MachinesController(IndustrialMachineryApiContext context)
        {
            _context = context;
        }
